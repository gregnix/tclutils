...
| `tkutils::tkudavbrowser` | 0.1 | a read-only navigation pane for a CalDAV/CardDAV server, built on tclutils::tudav. | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkudavbrowser-0.1.tm` | tclutils::tudav,tclutils::common |
| `tkutils::tkudialog` | 0.1 | dialogs with copyable message text | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkudialog-0.1.tm` | tkutils::tkuform |
...
| `tkutils::tkufiletree` | 0.1 | a lazy file-system tree built on tkutils::tkutree. | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkufiletree-0.1.tm` | tkutils::tkutree |
| `tkutils::tkufilterbar` | 0.1 | a per-column filter bar: one small entry per column, each typing a substring that the consumer ANDs together. | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkufilterbar-0.1.tm` |  |
...
| `tkutils::tkuical` | 0.1 | iCalendar event viewer/editor | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkuical-0.1.tm` | tclutils::tuical |
...
| `tkutils::tkuini` | 0.1 | INI viewer | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkuini-0.1.tm` | tclutils::tuini |
...
| `tkutils::tkuldif` | 0.1 | LDIF entry viewer/editor | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkuldif-0.1.tm` | tclutils::tuldif |
...
| `tkutils::tkunotes` | 0.1 | hierarchical notes widget | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkunotes-0.1.tm` | tclutils::tunotes |
...
| `tkutils::tkustatus` | 0.1 | status bar widget | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkustatus-0.1.tm` |  |
...
| `tkutils::tkutablelist` | 0.2 | multi-column table (OPTIONAL: requires Tablelist) | Tk · tablelist | Y | Y | Y | tkutils | `lib/tm/tkutils/tkutablelist-0.2.tm` | tablelist_tile,Tablelist,tclutils::tunum,tclutils::tucsv,tclutils::tunotes |
...
| `tkutils::tkutical` | 0.2 | month/week calendar widget (OPTIONAL: requires tical) | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkutical-0.2.tm` | tical::view::month,tical::view::week,tical::render::canvas |
...
| `tkutils::tkutlfmt` | 0.1 | per-column display formatting for a tablelist widget via tablelist's -formatcommand. | Tk · tablelist | Y | Y | Y | tkutils | `lib/tm/tkutils/tkutlfmt-0.1.tm` | tablelist,tclutils::tunum |
...
| `tkutils::tkutodo` | 0.1 | a task-list widget for iCalendar VTODO components, built on tclutils::tuical (todos / todoInfo / setProperty). | Tk · widgets | Y | Y | Y | tkutils | `lib/tm/tkutils/tkutodo-0.1.tm` | tclutils::tuical |
